...
// kindLabel — двуязычный объект {ru, mn}, читать через tr() из useLanguage().
// fromLabel/toLabel (сольфеджио вида «Ля (A₃)») намеренно оставлены на русском:
// это по сути буквенно-слоговые обозначения нот, а не описательный текст интерфейса.
const KIND_LABELS = {
  octave: { ru: 'октава (чистая, 0 биений)', mn: 'октав (цэвэр, 0 хэлбэлзэл)' },
  fifth: { ru: 'квинта (заужена)', mn: 'квинт (нарийсгасан)' },
  fourth: { ru: 'кварта (расширена)', mn: 'кварт (өргөтгөсөн)' },
}
