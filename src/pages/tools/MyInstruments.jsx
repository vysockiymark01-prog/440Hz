...
export default function MyInstruments() {
  ...
  const addItem = () => {
    ...
    const entry = { id: Date.now().toString(36), brand: brand.trim(), lastTuned, note: note.trim() }
  ...
  return (
    <div>
      ...
      <p className="screen-subtitle">
        Личный список без клиентов и оплат — просто чтобы не забыть, кому пора звонить с напоминанием.
      </p>
      ...
      <div className="card">
        ...
        <div style={{ marginBottom: 12 }}>
          ...
          <input type="text" placeholder="например, район, особенности" value={note} onChange={(e) => setNote(e.target.value)} />
        </div>
